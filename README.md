...
```bash
wget https://github.com/c0m4r/kula/releases/download/0.18.4/kula-0.18.4-x86_64.rpm
echo "fd83baf4c8087ea38adf2d6dc56d94a152244418b3e9c467eaaa1e1bc4f3d4fa kula-0.18.4-x86_64.rpm" | sha256sum -c || rm -f kula-0.18.4-x86_64.rpm
sudo rpm -i kula-0.18.4-x86_64.rpm
journalctl -f -t kula
```
